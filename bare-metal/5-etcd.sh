...
sudo sh -c "echo 'initial-cluster: controller=http://10.0.0.17:2380' >> /etc/etcd/etcd.conf.yml"
sudo sh -c "echo 'initial-advertise-peer-urls: http://10.0.0.17:2380' >> /etc/etcd/etcd.conf.yml"
sudo sh -c "echo 'advertise-client-urls: http://10.0.0.17:2379' >> /etc/etcd/etcd.conf.yml"
sudo sh -c "echo 'listen-peer-urls: http://0.0.0.0:2380' >> /etc/etcd/etcd.conf.yml"
sudo sh -c "echo 'listen-client-urls: http://10.0.0.17:2379' >> /etc/etcd/etcd.conf.yml"
