...
openstack user create --domain default --password secret placement >> nova.log 2>> nova-error.log
...
sudo sed -i "$[linhadefaultnova+5] i\my_ip = 10.0.0.11" /etc/nova/nova.conf
