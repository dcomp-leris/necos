...
sudo sed -i "$[linhaml2neutron+3] i\mechanism_drivers = linuxbridge,l2_population" /etc/neutron/plugins/ml2/ml2_conf.ini
...
sudo sed -i "$[linhadefaultmetadataneutron+2] i\metadata_proxy_shared_secret = $2" /etc/neutron/metadata_agent.ini
